...
public class solarSystem  implements IRenderable {
    ...
    private boolean isLight = false;
          ...
          private void setLight(GL gl, GLU glu) {
            ...
            gl.glLightModelfv(2899, new float[]{1.0F, 1.0F, 0.5F, 1F}, 0);
          ...
          private void PlanetManufacter(List<Planet> solarsPlanet, boolean wFrame, boolean isAxis) {
            ...
            solarsPlanet.add(new Planet(0.0D, 0.0D, Planet.PlanetType.SUN, null, colorToDoubleArray(Colors.Yellow), wFrame, 0.0D, sunOffsetLocation + 0.1D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 4.0D, 2.0D, Planet.PlanetType.MERCURY, null, colorToDoubleArray(Colors.Cyan), wFrame, 7.0D, sunOffsetLocation * 0.1D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 6.0D, 2.0D, Planet.PlanetType.VENUS, null, colorToDoubleArray(Colors.Blue) , wFrame, 3.39D, sunOffsetLocation * 0.3D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 8.0D, 23.45D, Planet.PlanetType.EARTH, null, colorToDoubleArray(Colors.GreenYellow) , wFrame, 0.0D, sunOffsetLocation * 0.4D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 10.0D, 24.0D, Planet.PlanetType.MARS, null, colorToDoubleArray(Colors.Red) , wFrame, 1.85D, sunOffsetLocation * 0.1D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 12.0D, 3.1D, Planet.PlanetType.JUPITER, null, colorToDoubleArray(Colors.Purple) , wFrame, 1.3D, sunOffsetLocation * 1.4D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 16.0D, 26.7D, Planet.PlanetType.SATURN, null,colorToDoubleArray(Colors.Green) , wFrame, 2.49D, sunOffsetLocation * 1.2D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 18.0D, 97.9D, Planet.PlanetType.URANUS, null,colorToDoubleArray(Colors.White) , wFrame, 0.77D, sunOffsetLocation * 0.8D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 20.0D, 28.8D, Planet.PlanetType.NEPTUNE, null, colorToDoubleArray(Colors.Orange), wFrame, 1.77D, sunOffsetLocation * 0.8D, isAxis));
            solarsPlanet.add(new Planet(sunOffsetLocation * 22.0D, 57.5D, Planet.PlanetType.PLUTO, null, colorToDoubleArray(Colors.Blue), wFrame, 17.2D, sunOffsetLocation * 0.2D, isAxis));
          }
